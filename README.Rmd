...
Before we use this output for any further analysis, we should reverse the rescaling introduced with the `unit_scaling` parameter to fit to the input data again.
