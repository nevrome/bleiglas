...
2. A [JOSS paper](https://github.com/nevrome/bleiglas/blob/master/paper/paper.md) (in Review) gives some background, introduces the core functions from a more technical point of view and presents an example application.
...
<table style="width:100%">
  <tr>
    ...
    <th>
      <figure><img src="http://math.lbl.gov/voro++/examples/custom_output/custom_output_l.png" height="150" />
      <br>
