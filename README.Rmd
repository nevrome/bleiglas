...
<details><summary>Data: <b>polygon\_edges</b></summary>
<p>
...
<details><summary>Before we do that, we can change the scaling of the temporal information again to increase the readability of the plot.</summary>
<p>
...
```{r, webgl=TRUE, fig.width=10, fig.align="center"}
rgl::axes3d()
...
<details><summary>Data: <b>cut\_surfaces</b></summary>
<p>
