...
[![Travis-CI Build Status](https://travis-ci.org/nevrome/bleiglas.svg?branch=master)](https://travis-ci.org/nevrome/bleiglas) [![Coverage Status](https://img.shields.io/codecov/c/github/nevrome/bleiglas/master.svg)](https://codecov.io/github/nevrome/bleiglas?branch=master)
...
2. A [JOSS paper](https://github.com/nevrome/bleiglas/blob/master/paper/paper.md) (not submitted yet) gives some background and introduces the core functions from a more technical point of view
